...
class Ui_MeasureIt(object):
    def setupUi(self, MeasureIt):
        ...
        self.tabWidget = QtWidgets.QTabWidget(self.controlBox)
        self.tabWidget.setGeometry(QtCore.QRect(0, 100, 127, 80))
    ...
    def retranslateUi(self, MeasureIt):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MeasureIt", "Tab 1"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MeasureIt", "Tab 2"))
