...
class Ui_MeasureIt(object):
    def setupUi(self, MeasureIt):
        ...
        self.actionSetup_2D_Sweep = QtWidgets.QAction(MeasureIt)
        self.actionSetup_2D_Sweep.setObjectName("actionSetup_2D_Sweep")
        ...
        self.menu2D_Sweep.addAction(self.actionSetup_2D_Sweep)
    ...
    def retranslateUi(self, MeasureIt):
        ...
        self.actionSetup_2D_Sweep.setText(_translate("MeasureIt", "Setup 2D Sweep"))
