...
class Ui_MeasureIt(object):
    def setupUi(self, MeasureIt):
        ...
        self.scanGroupBox.setGeometry(QtCore.QRect(500, 10, 401, 441))
        ...
        self.controlBox.setGeometry(QtCore.QRect(180, 280, 201, 121))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(200, 30, 161, 201))
        ...
        self.scanParameterBox.setGeometry(QtCore.QRect(100, 30, 81, 22))
        ...
        self.followParamTable.setGeometry(QtCore.QRect(10, 30, 431, 261))
        ...
        self.outputParamTable.setGeometry(QtCore.QRect(10, 30, 431, 221))
        ...
        self.consoleEdit.setGeometry(QtCore.QRect(10, 30, 381, 161))
        ...
        self.sequenceWidget.setGeometry(QtCore.QRect(10, 30, 301, 491))
        ...
        self.downSequenceButton.setGeometry(QtCore.QRect(180, 540, 51, 23))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1249, 24))
        ...
        self.actionSetup = QtWidgets.QAction(MeasureIt)
        self.actionSetup.setObjectName("actionSetup")
        self.actionCreate_2D_Sweep = QtWidgets.QAction(MeasureIt)
        ...
        self.menu2D_Sweep.addAction(self.actionCreate_2D_Sweep)
    ...
    def retranslateUi(self, MeasureIt):
        ...
        self.actionSetup.setText(_translate("MeasureIt", "Setup"))
        self.actionCreate_2D_Sweep.setText(_translate("MeasureIt", "Setup 2D Sweep"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    MeasureIt = QtWidgets.QMainWindow()
    ui = Ui_MeasureIt()
    ui.setupUi(MeasureIt)
    MeasureIt.show()
    sys.exit(app.exec_())
